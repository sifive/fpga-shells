...
package sifive.fpgashells.shell.xilinx.zyboshell
...
abstract class ZyboShell(implicit val p: Parameters) extends RawModule {
  ...
  CLK100MHZ := armps_0.io.FCLK_CLK0
  ck_rst := armps_0.io.FCLK_RESET0_N
