...
// IP VLNV: xilinx.com:customize_ip:genesys2mig:1.0
// Black Box

class Genesys2MIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
  require((depth<=0x40000000L),"Genesys2MIGIODDR supports upto 1GB depth configuraton")
...
//reused directly in io bundle for sifive.blocks.devices.xilinxgenesys2mig
...
class genesys2mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  ...
  override def desiredName = "genesys2mig1gb"

  val io = new Genesys2MIGIODDR(depth) with Genesys2MIGIOClocksReset {
    // User interface signals
  ...
  val genesys2mig1gbprj = """ {<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
<Project NoOfControllers="1">
  ...
  val migprj = genesys2mig1gbprj
  val migprjname =  """{/genesys2mig1gb.prj}"""
  val modulename =  """genesys2mig1gb"""
