...
case class ClockSourceNode(portParams: Seq[ClockSourceParameters])(implicit valName: ValName) extends SourceNode(ClockImp)(portParams)
case class ClockSinkNode(portParams: Seq[ClockSinkParameters])(implicit valName: ValName) extends SinkNode(ClockImp)(portParams)
...
object ClockSinkNode
{
  def apply(
    ...
    phaseErrorDeg: Double = 10,
    freqErrorPPM:  Double = 10000,
    jitterPS:      Double = 10)(implicit valName: ValName): ClockSinkNode =
...
object ClockSourceNode
{
  def apply(
    freqMHz:   Double,
    dutyCycle: Double = 50,
    jitterPS:  Double = 50)(implicit valName: ValName): ClockSourceNode =
