...
# Generate IP implementations. Intel-Altera TCL emitted from Chisel Blackboxes
...
#  }
# IP configuration file {altera}.qip versus {xilinx}.xci
set xci_files [get_files -all {*.qip}]
foreach xci_file $xci_files {
  set_property GENERATE_SYNTH_CHECKPOINT {false} -quiet $xci_file
}
